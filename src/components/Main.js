      ...
      >
        ...
        <Container>
          ...
          <Center click={click}>
            ...
            <span   onClick={() => handleClick()} className="click_animation"><b>Click here</b></span>
          </Center>
          ...
          {mq ? (
            <Contact
              click={+click}
              target="_blank"
              to={{ pathname: "mailto:carlosluisprad@gmail.com" }}
            >
              <motion.h3
                initial={{
                  y: -200,
          ...
          {mq ? (
            <BLOG click={+click} onClick={() => setpath("studies")} to="/studies">
              <motion.h2
                initial={{
                  y: -200,
                  transition: { type: "spring", duration: 1.5, delay: 1 },
            ...
            <BLOG click={+false} onClick={() => setpath("studies")} to="/studies">
              <motion.h2
                initial={{
                  y: -200,
                  transition: { type: "spring", duration: 1.5, delay: 1 },
